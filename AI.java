...
class AI
{
	...
	Node getMax(int depth,Piece user,Piece piece, Tile[][] tiles)
	{
		return(Max(depth,user,piece,new Node((int)(Double.NEGATIVE_INFINITY)),new Node((int)Double.POSITIVE_INFINITY),tiles));
	}
